...
<div class="panel-group" id="accordion">
                <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">
                            <table class="table">
                                <tr>
                                    <td>
                                        <span class="glyphicon glyphicon-pencil text-primary"></span><a href="#"> Admins</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <span class="glyphicon glyphicon-flash text-success"></span><a href="#"> Users</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <span class="glyphicon glyphicon-file text-info"></span><a href="#"> Subscribers</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion2" href="#collapseOnex"><span class="glyphicon glyphicon-user">
                            </span> Roles</a>
                        </h4>
                    </div>
                                            <div id="collapseOnex" class="panel-collapse collapse" onclick="return function(e){e.stopPropagation();}">
                        <div class="panel-body">
                            <table class="table">
                                <tr>
                                    <td>
                                        <span class="glyphicon glyphicon-pencil text-primary"></span><a href="#"> Admin</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <span class="glyphicon glyphicon-comment text-success"></span><a href="#"> Authors</a>
